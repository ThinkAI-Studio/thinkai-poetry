  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16">
      ...
      <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-14">
        ...
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-900 dark:text-neutral-50 tracking-tight mb-4">
          Tuyển Tập <span className="italic font-normal text-[#2D5A3D] dark:text-[#5BA26B]">Thi Ca Chọn Lọc</span>
        </h1>
        <p className="font-serif text-base sm:text-lg text-neutral-600 dark:text-neutral-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {mockCollections.map((col) => (
          <Link
            ...
            className="tai-card group flex flex-col justify-between overflow-hidden p-6 hover:-translate-y-1 transition-all duration-300 rounded-2xl"
          >
            <div>
              {/* Cover / Icon */}
              ...
              {/* Title & Description */}
              <h2 className="font-serif font-bold text-xl text-neutral-900 dark:text-neutral-100 group-hover:text-[#2D5A3D] dark:group-hover:text-[#4ade80] transition-colors mb-2 line-clamp-1">
                {col.title}
              </h2>
