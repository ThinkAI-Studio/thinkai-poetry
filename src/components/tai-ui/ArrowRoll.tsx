...
export function ArrowRoll({ className = "", size = "md" }: ArrowRollProps) {
  ...
  return (
    <span
      className={`relative overflow-hidden rounded-full bg-black text-white group-hover:bg-white group-hover:text-black inline-flex items-center justify-center font-extrabold shrink-0 transition-colors duration-300 select-none leading-none ${sizeClasses} ${className}`}
    >
