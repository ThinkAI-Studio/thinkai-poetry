  ...
  (
    ...
    const innerContent = (
      <>
        ...
        {!prefersReduced && (
          <motion.div
            ...
            transition={
              wipeState === "idle"
                ? { duration: 0 }
                : { duration: 0.35, ease: TAI_EASE.luxury }
            }
            onAnimationComplete={() => {
              if (wipeState === "out") {
                setWipeState("idle");
        ...
        {/* Foreground Content */}
        <span
          className="relative z-10 inline-flex items-center justify-center gap-2.5 sm:gap-3 w-full h-full transition-colors duration-250 leading-none"
          style={{
