...
VALUES
  (
    ...
    'thinh-wind',
    'Văn học đương đại',
    'Tác giả Thịnh (Ký danh: Wind) — Người gieo vần cho những miền ký ức và triết lý nhân sinh sâu lắng. Tác giả của các thi phẩm đương đại giàu cảm xúc trong không gian thi ca Wind.',
